"""
Este módulo contiene las funciones para aplicar la ingeniería de características
"""
...
def create_model_features():
    """
    Función para desarrollar ingeniería de características
    """
    dataset = pd.read_csv("../data/raw/train.csv")
    dataset.drop(['PassengerId', 'Name', 'Ticket'], axis=1, inplace=True)
    # Eliminamos la columna Cabin dado que tiene 77% de faltantes
